	...
	/* $(function(){
	 ...
	 function addBackendUser() {
			...
			var param = {
					...
					name : $("#name1").val(),
					phone : $("#phone1").val(),
					sex : $("#sex1 option:selected").val(),
					roleId : $("#roleId1 option:selected").val()
				}
			console.log(param);
				...
				<header class="panel-heading">
					...
					<div class="clearfix">
						<div class="pull-right">
							<span 
								<button href="#myModal_editrole" data-toggle="modal"  onclick="managerCron('+value.ID+');" 
						class="label btn label-success green"><i class="icon-plus">>新增</i></button>
							</span>
						</div>
					</div>
				</header>
  ...
  <div class="modal-dialog">
	  <div class="modal-content">
		  <div class="modal-header">
			  ...
			  <h4 class="modal-title" id="roleTitle">新增后台用户</h4>
		  </div>
		  <div class="modal-body">
			  <form role="form" class="form-horizontal" id="editJobform" >
              <div class="form-group">
                   <label class="col-lg-2 col-sm-2 control-label" >登录名</label>
                   <div class="col-lg-10">
                       <input type="text" placeholder="" id="loginName1" name="loginName1" class="form-control">
                   </div>
               </div>
                <div class="form-group">
                   <label class="col-lg-2 col-sm-2 control-label" >真实姓名</label>
                   <div class="col-lg-10">
                       <input type="text" placeholder="" id="name1" name="name1" class="form-control">
                   </div>
               </div>
                <div class="form-group">
                   <label class="col-lg-2 col-sm-2 control-label" >电话</label>
                   <div class="col-lg-10">
                       <input type="text" placeholder="" id="phone1" name="phone1" class="form-control">
                   </div>
               </div>
                <div class="form-group">
                   <label class="col-lg-2 col-sm-2 control-label" >性别</label>
                   <div class="col-lg-10">
                       <select type="text" id="sex1" name="sex1"
									class="form-control">
                ...
                <div class="form-group">
                   ...
                   <div class="col-lg-10">
                       <select type="text" id="roleId1" name="roleId1"
									class="form-control">
									<option value="1">普通后台</option>
									<option value="2">管理员</option>
								</select>
                   </div>
               </div>
				  ...
				  <div class="col-lg-5" ></div>
				  		<div class="col-lg-5" >
						  <button class="btn btn-primary" type="button" onclick="addBackendUser();">确认</button>
						  </div>
				  </div>
			  </form>
		  </div>
